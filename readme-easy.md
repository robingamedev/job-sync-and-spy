# 🚀 Easy Quick Start for Job Sync and Spy

Not an engineer? No problem! This guide will get you up and running in just a few clicks.

## Step 1: Install Docker Desktop

We use Docker to run everything safely on your computer without installing complicated programming languages.

1. Download [Docker Desktop](https://www.docker.com/products/docker-desktop/).
2. Install it.
3. Open it up (make sure you see the little whale icon running in your system tray or menu bar).
